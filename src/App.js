  ...
  const DeteccionFraudes = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white">Detección de Fraudes</h1>
        <div className="flex items-center space-x-2">
          <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
          <span className="text-sm text-gray-300">Sistema ML Activo</span>
        </div>
      </div>
...
const SistemaGestionSeguros = () => {
          ...
          <div className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-slate-600">Prima Mensual</span>
                  <span className="text-2xl font-bold text-blue-600">${resultadoCotizacion.primaMensual}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-slate-600">Prima Anual</span>
                  <span className="text-lg font-semibold text-slate-800">${resultadoCotizacion.primaAnual}</span>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-slate-600">Valor de Cobertura:</span>
                  <span className="font-medium">${parseFloat(resultadoCotizacion.cobertura).toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-600">Deducible:</span>
                  <span className="font-medium">${parseFloat(resultadoCotizacion.deducible).toLocaleString()}</span>
                </div>
              </div>
  ...
  const RevisarAccidentes = () => (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-white">Revisar Accidentes</h1>
        <div className="flex items-center space-x-2">
          <Car className="w-5 h-5 text-gray-300" />
          <span className="text-sm text-gray-300">Módulo de Evaluación</span>
        </div>
      </div>
      ...
      <div className="flex space-x-4">
        ...
        <button className="px-4 py-2 bg-white text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-100">
          Pendientes
        </button>
        <button className="px-4 py-2 bg-white text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-100">
          En Proceso
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <p><span className="text-gray-600">Cliente:</span> Juan Pérez</p>
                    <p><span className="text-gray-600">Póliza:</span> POL-2024-001</p>
                    <p><span className="text-gray-600">Vehículo:</span> Toyota Corolla 2020</p>
                    <p><span className="text-gray-600">Teléfono:</span> +503 7123-4567</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <p><span className="text-gray-600">Fecha:</span> 15 de Agosto, 2024</p>
                    <p><span className="text-gray-600">Hora:</span> 14:30</p>
                    <p><span className="text-gray-600">Ubicación:</span> Av. Roosevelt, San Salvador</p>
                    <p><span className="text-gray-600">Tipo:</span> Colisión trasera</p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex-1">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                <div>
                  <h4 className="font-medium text-slate-700 mb-2">Información del Asegurado</h4>
                  <div className="space-y-1 text-sm">
                    <p><span className="text-gray-600">Cliente:</span> María González</p>
                    <p><span className="text-gray-600">Póliza:</span> POL-2024-002</p>
                    <p><span className="text-gray-600">Propiedad:</span> Casa residencial</p>
                    <p><span className="text-gray-600">Teléfono:</span> +503 7234-5678</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-1 text-sm">
                    <p><span className="text-gray-600">Fecha:</span> 20 de Agosto, 2024</p>
                    <p><span className="text-gray-600">Hora:</span> 02:15</p>
                    <p><span className="text-gray-600">Ubicación:</span> Col. Escalón, Santa Ana</p>
                    <p><span className="text-gray-600">Tipo:</span> Robo con fuerza</p>
                  </div>
                </div>
              </div>
